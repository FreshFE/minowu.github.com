...
a,!0);c.css({width:d.width,height:d.height});b.pagePlace[a]=a;b.pageWrap[a]=g("<div/>",{"class":"page-wrapper",page:a,css:{position:"absolute",overflow:"hidden"}}).css(d);this.append(b.pageWrap[a]);b.pageObjs[a].appendTo(b.pageWrap[a])}h._makeFlip.call(this,a)}else b.pagePlace[a]=0,b.pageObjs[a]&&b.pageObjs[a].remove()},hasPage:function(a){return n(a,this.data().pageObjs)},center:function(a){var b=this.data(),c=g(this).turn("size"),d=c.width/(2*b.zoom)-c.width/2;b.noCenter||("double"==b.display&&
...
delete e.pagePlace[a],delete e.pageObjs[a],delete e.pageWrap[a],delete e.pageObjs[a]))};if(0<b)for(c=e.totalPages;c>=a;c--)g(c);else for(c=a;c<=e.totalPages;c++)g(c)},display:function(a){var b=this.data(),c=b.display;if("undefined"==typeof a)return c;if(-1==g.inArray(a,S))throw p('"'+a+'" is not a value for display');switch(a){case "single":b.pageObjs[0]||(this.turn("stop").css({overflow:"hidden"}),b.pageObjs[0]=g("<div />",{"class":"page p-temporal"}).css({width:this.width(),height:this.height()}).appendTo(this));
this.addClass("shadow");break;case "double":b.pageObjs[0]&&(this.turn("stop").css({overflow:""}),b.pageObjs[0].remove(),delete b.pageObjs[0]),this.removeClass("shadow")}b.display=a;c&&(a=this.turn("size"),h._movePages.call(this,1,0),this.turn("size",a.width,a.height).turn("update"));return this},direction:function(a){var b=this.data();if("undefined"==typeof a)return b.direction;a=a.toLowerCase();if(-1==g.inArray(a,T))throw p('"'+a+'" is not a value for direction');"rtl"==a&&g(this).attr("dir","ltr").css({direction:"ltr"});
...
a%2?[a-1,a]:[a,a+1]:[a]},view:function(a){var b=this.data(),a=h._view.call(this,a);return"double"==b.display?[0<a[0]?a[0]:0,a[1]<=b.totalPages?a[1]:0]:[0<a[0]&&a[0]<=b.totalPages?a[0]:0]},stop:function(a,b){if(this.turn("animating")){var c,d,e,f=this.data();f.tpage&&(f.page=f.tpage,delete f.tpage);for(c=0;c<f.pageMv.length;c++)f.pageMv[c]&&f.pageMv[c]!==a&&(e=f.pages[f.pageMv[c]],d=e.data().f.opts,e.flip("hideFoldedPage",b),b||i._moveFoldingPage.call(e,!1),d.force&&(d.next=0===d.page%2?d.page-1:d.page+
1,delete d.force))}this.turn("update");return this},pages:function(a){var b=this.data();if(a){if(a<b.totalPages)for(var c=b.totalPages;c>a;c--)this.turn("removePage",c);b.totalPages=a;h._fitPage.call(this,b.page);return this}return b.totalPages},_missing:function(a){for(var b=this.data(),c=this.turn("range",a),d=[],a=c[0];a<=c[1];a++)b.pageObjs[a]||d.push(a);0<d.length&&this.trigger("missing",[d])},_fitPage:function(a){var b=this.data(),c=this.turn("view",a);h._missing.call(this,a);b.pageObjs[a]&&
(b.page=a,this.turn("stop"),h._removeFromDOM.call(this),h._makeRange.call(this),h._updateShadow.call(this),this.trigger("turned",[a,c]),this.turn("update"),b.opts.autoCenter&&this.turn("center"))},_turnPage:function(a,b){var c,d,e=this.data(),f=e.pagePlace[a],k=this.turn("view"),i=this.turn("view",a);if(e.page!=a){var j=e.page;if("prevented"==v("turning",this,[a,i])){j==e.page&&-1!=g.inArray(f,e.pageMv)&&e.pages[f].flip("hideFoldedPage",!0);return}-1!=g.inArray(1,i)&&this.trigger("first");-1!=g.inArray(e.totalPages,
i)&&this.trigger("last")}if(b)this.turn("stop",f);else{h._missing.call(this,a);if(!e.pageObjs[a])return;this.turn("stop");e.page=a}h._makeRange.call(this);"single"==e.display?(c=k[0],d=i[0]):k[1]&&a>k[1]?(c=k[1],d=i[0]):k[0]&&a<k[0]&&(c=k[0],d=i[1]);e.pages[c]&&(f=e.pages[c].data().f,k=f.opts,i=e.opts.turnCorners.split(","),e.tpage=d,k.next!=d&&(k.next=d,k.force=!0),this.turn("update"),"hard"==f.effect?"ltr"==e.direction?e.pages[c].flip("turnPage",a>c?"r":"l"):e.pages[c].flip("turnPage",a>c?"l":"r"):
"ltr"==e.direction?e.pages[c].flip("turnPage",i[a>c?1:0]):e.pages[c].flip("turnPage",i[a>c?0:1]))},page:function(a){var b=this.data();if(void 0===a)return b.page;if(!b.disabled&&!b.destroying){a=parseInt(a,10);if(0<a&&a<=b.totalPages)return a!=b.page&&(!b.done||-1!=g.inArray(a,this.turn("view"))?h._fitPage.call(this,a):h._turnPage.call(this,a)),this;throw p("The page "+a+" doesn't exist");}},next:function(){return this.turn("page",Math.min(this.data().totalPages,h._view.call(this,this.data().page).pop()+
1))},previous:function(){return this.turn("page",Math.max(1,h._view.call(this,this.data().page).shift()-1))},peel:function(a,b){var c=this.data(),d=this.turn("view"),b="undefined"==typeof b?!0:!0===b;if(!1===a)this.turn("stop",null,b);else if("single"==c.display)c.pages[c.page].flip("peel",a,b);else if(d="ltr"==c.direction?-1!=a.indexOf("l")?d[0]:d[1]:-1!=a.indexOf("l")?d[1]:d[0],c.pages[d])c.pages[d].flip("peel",a,b);else throw p("Unexpected corner "+a);return this},_addMotionPage:function(){var a=
g(this).data().f.opts,b=a.turn;b.data();h._addMv.call(b,a.page)},_start:function(a,b,c){var d=b.turn.data();a.isDefaultPrevented()||("single"==d.display&&c&&("l"==c.charAt(1)&&"ltr"==d.direction||"r"==c.charAt(1)&&"rtl"==d.direction?(b.next=b.next<b.page?b.next:b.page-1,b.force=!0):b.next=b.next>b.page?b.next:b.page+1),h._addMotionPage.call(a.target));h._updateShadow.call(b.turn)},_end:function(a,b,c){g(a.target).data();var a=b.turn,d=a.data();if(c){if(c=d.tpage||d.page,c==b.next||c==b.page)delete d.tpage,
h._fitPage.call(a,c||b.next,!0)}else h._removeMv.call(a,b.page),h._updateShadow.call(a),a.turn("update")},_pressed:function(a){var a=g(a.target).data().f,b=a.opts.turn;b.data().mouseAction=!0;b.turn("update");return a.time=(new Date).getTime()},_released:function(a,b){var c,d=g(a.target),e=d.data().f,f=e.opts.turn,k=f.data();c="single"==k.display?"br"==b.corner||"tr"==b.corner?b.x<d.width()/2:b.x>d.width()/2:0>b.x||b.x>d.width();if(200>(new Date).getTime()-e.time||c)a.preventDefault(),h._turnPage.call(f,
e.opts.next,!1===i._cornerActivated.call(d,b,1));k.mouseAction=!1},_flip:function(a){a.stopPropagation();a=g(a.target).data().f.opts;a.turn.trigger("turn",[a.next]);a.turn.data().opts.autoCenter&&a.turn.turn("center",a.next)},calculateZ:function(a){var b,c,d,e,f=this,g=this.data();b=this.turn("view");var i=b[0]||b[1],h=a.length-1,j={pageZ:{},partZ:{},pageV:{}},o=function(a){a=f.turn("view",a);a[0]&&(j.pageV[a[0]]=!0);a[1]&&(j.pageV[a[1]]=!0)};for(b=0;b<=h;b++)c=a[b],d=g.pages[c].data().f.opts.next,
e=g.pagePlace[c],o(c),o(d),c=g.pagePlace[d]==d?d:c,j.pageZ[c]=g.totalPages-Math.abs(i-c),j.partZ[e]=2*g.totalPages-h+b;return j},update:function(){var a,b=this.data();if(this.turn("animating")&&0!==b.pageMv[0]){var c,d=this.turn("calculateZ",b.pageMv),e=this.turn("corner"),f=this.turn("view"),i=this.turn("view",b.tpage);for(a in b.pageWrap)if(n(a,b.pageWrap)&&(c=b.pageObjs[a].hasClass("fixed"),b.pageWrap[a].css({display:d.pageV[a]||c?"":"none",zIndex:(b.pageObjs[a].hasClass("hard")?d.partZ[a]:d.pageZ[a])||
(c?-1:0)}),c=b.pages[a]))c.flip("z",d.partZ[a]||null),d.pageV[a]&&c.flip("resize"),b.tpage?c.flip("hover",!1).flip("disable",-1==g.inArray(parseInt(a,10),b.pageMv)&&a!=i[0]&&a!=i[1]):c.flip("hover",!1===e).flip("disable",a!=f[0]&&a!=f[1])}else for(a in b.pageWrap)n(a,b.pageWrap)&&(d=h._setPageLoc.call(this,a),b.pages[a]&&b.pages[a].flip("disable",b.disabled||1!=d).flip("hover",!0).flip("z",null));return this},_updateShadow:function(){var a,b,c=this.data(),d=this.width(),e=this.height(),f="single"==
c.display?d:d/2;a=this.turn("view");c.shadow||(c.shadow=g("<div />",{"class":"shadow",css:l(0,0,0).css}).appendTo(this));for(var i=0;i<c.pageMv.length&&a[0]&&a[1];i++)a=this.turn("view",c.pages[c.pageMv[i]].data().f.opts.next),b=this.turn("view",c.pageMv[i]),a[0]=a[0]&&b[0],a[1]=a[1]&&b[1];switch(a[0]?a[1]?3:"ltr"==c.direction?2:1:"ltr"==c.direction?1:2){case 1:c.shadow.css({width:f,height:e,top:0,left:f});break;case 2:c.shadow.css({width:f,height:e,top:0,left:0});break;case 3:c.shadow.css({width:d,
height:e,top:0,left:0})}},_setPageLoc:function(a){var b=this.data(),c=this.turn("view"),d=0;if(a==c[0]||a==c[1])d=1;else if("single"==b.display&&a==c[0]+1||"double"==b.display&&a==c[0]-2||a==c[1]+2)d=2;if(!this.turn("animating"))switch(d){case 1:b.pageWrap[a].css({zIndex:b.totalPages,display:""});break;case 2:b.pageWrap[a].css({zIndex:b.totalPages-1,display:""});break;case 0:b.pageWrap[a].css({zIndex:0,display:b.pageObjs[a].hasClass("fixed")?"":"none"})}return d},options:function(){return this.data().opts},
version:function(){return"4.0.8"}},i={init:function(a){this.data({f:{disabled:!1,hover:!1,effect:this.hasClass("hard")?"hard":"sheet"}});this.flip("options",a);i._addPageWrapper.call(this);return this},setData:function(a){var b=this.data();b.f=g.extend(b.f,a);return this},options:function(a){var b=this.data().f;return a?(i.setData.call(this,{opts:g.extend({},b.opts||V,a)}),this):b.opts},z:function(a){var b=this.data().f;b.opts["z-index"]=a;b.fwrapper&&b.fwrapper.css({zIndex:a||parseInt(b.parent.css("z-index"),
