/* ============================================================
 * Tabs v1.0
 * api.meside.com/uiframe/javascript#tabs
 * ============================================================
 * Copyright 2012 Methink, Inc. 2012.1.24
 * 
 * By Mino Royuan Wu
 * ============================================================ */
/*
	...
	$.fn.tabs = function(){
		return this.each(function(){
			...
			t.live('click',function(){
				var tabFrame = t.parent().parent();
				tabFrame.children('li').removeClass('current');
				t.parent('li').addClass('current');
				var loadLink = t.prop('href');
				tabFrame.next().load(loadLink);
				return false;
			});
		});
	}
...
/* ============================================================
 * common.js developing
 * api.meside.com/uiframe/javascript
 * ============================================================
 * Copyright 2012 Methink, Inc. 2012.1.20
 * 
 * By Mino Royuan Wu
 * ============================================================ */
